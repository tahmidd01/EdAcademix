...
<li class="nav-item dropdown" id="dreamDropdown">
 ...
 <!-- Navbar HTML part end  -->
  ...
  <!-- contact form html part start -->
<!-- CONTACT BANNER SECTION -->
<div class="contact-banner">
  <div class="contact-banner-overlay">
    <div class="container text-white text-center py-5">
      <h1 class="mb-3">CONTACT US</h1>
      <p class="mb-5">Have any questions or want to get in touch? Feel free to contact us.</p>

      <div class="contact-box p-4 rounded">
        <div class="row g-4">
            ...
            <div class="row g-3">
              ...
              <!-- <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/EDLOGO.png" class="member-img img-fluid">
                  <h5>EdAcademix</h5>
                  <p>iamksrahil03@gmail.com</p>
                </div>
              </div> -->
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/r.jpg" class="member-img img-fluid">
                  <h5>Kazi Shibli Zaman Rahil</h5>
                  <p>iamksrahil03@gmail.com</p>
                  <div class="social-icons">
                    <a href="https://www.facebook.com/rahil03" target="_blank">
                    <i class="fab fa-facebook-f me-2 text-warning"></i></a>
					<a href="https://www.instagram.com/iamksrahilofficial?igsh=cXc4YzJweWd3ejJ4" target="_blank">
                    <i class="fab fa-instagram me-2 text-warning"></i></a>
					<a href="https://www.linkedin.com/in/iamrahil" target="_blank">
                    <i class="fab fa-linkedin-in text-warning"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/n.jpeg" class="member-img img-fluid">
                  <h5>Nazifa Tabassum</h5>
                  <p>rawshanniva14@gmail.com</p>
                  <div class="social-icons">
                    <a href="https://www.facebook.com/nazifa.tabassum.462207/" target="_blank">
                    <i class="fab fa-facebook-f me-2 text-warning"></i></a>
					<a href="https://www.instagram.com/imnazifa_t_shoily/" target="_blank">
                    <i class="fab fa-instagram me-2 text-warning"></i></a>
					<a href="https://www.linkedin.com/in/nazifa-tabassum-8a7084266/" target="_blank">
                    <i class="fab fa-linkedin-in text-warning"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/b.jpeg" class="member-img img-fluid">
                  <h5>Hasan Al Banna</h5>
                  <p>hasanalbanna01234@gmail.com</p>
                   <div class="social-icons">
                    <a href="https://www.facebook.com/hasan.al.banna.251480" target="_blank">
                    <i class="fab fa-facebook-f me-2 text-warning"></i></a>
					<a href="https://www.instagram.com/___little____boy___?igsh=aW95eGV1dGNnajRr" target="_blank">
                    <i class="fab fa-instagram me-2 text-warning"></i></a>
					<a href="https://www.linkedin.com/in/hasan-al-banna-011740293" target="_blank">
                    <i class="fab fa-linkedin-in text-warning"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/s.jpg" class="member-img img-fluid">
                  <h5>Jannatul Ferdus Setu</h5>
                  <p>jannatulsetu68@gmail.com</p>
                  <div class="social-icons">
                    <a href="https://www.facebook.com/profile.php?id=100007097929021" target="_blank">
                    <i class="fab fa-facebook-f me-2 text-warning"></i></a>
					<a href="https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=o8hlspr" target="_blank">
                    <i class="fab fa-instagram me-2 text-warning"></i></a>
					<a href="https://www.linkedin.com/in/jannatul-ferdus-setu-59614b35b/?originalSubdomain=bd" target="_blank">
                    <i class="fab fa-linkedin-in text-warning"></i></a>
                  </div>
                </div>
              </div>
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="member-card text-center h-100">
                  <img src="img/t.jpg" class="member-img img-fluid">
                  <h5>Tahmid Ahmed Talukdar</h5>
                  <p>tahmidahmed789456@gmail.com</p>
                  <div class="social-icons">
                    <a href="https://www.facebook.com/midzz.01" target="_blank">
                    <i class="fab fa-facebook-f me-2 text-warning"></i></a>
					<a href="https://www.instagram.com/tahmid__1?igsh=MWtkNWdjbWUyOWdpeA==" target="_blank">
                    <i class="fab fa-instagram me-2 text-warning"></i></a>
					<a href="https://www.linkedin.com/in/tahmid-ahmed-417712285 " target="_blank">
                    <i class="fab fa-linkedin-in text-warning"></i></a>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <h4 class="mb-4 text-start">Contact Form</h4>
<form class="contact-form" method="POST">
  <div class="mb-3">
    <input type="text" name="name" class="form-control bg-transparent text-white border-bottom" placeholder="Name" required>
  </div>
  <div class="mb-3">
    <input type="email" name="email" class="form-control bg-transparent text-white border-bottom" placeholder="Email" required>
  </div>
  <div class="mb-3">
    <textarea name="message" class="form-control bg-transparent text-white border-bottom" rows="4" placeholder="Message" required></textarea>
  </div>
