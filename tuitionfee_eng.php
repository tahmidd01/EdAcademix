...
<form class="d-flex" role="search" method="get" action="search_eng.php" onsubmit="return validateSearch()">
...
<nav class="second-navbar">
	<div class="container">
	  <ul class="nav-list">
		...
		<li class="left-group">
		  ...
		  <a href="uni_eng.php">Universities</a>
		</li>
 ...
 <div class="container-fluid mt-0">
	<div class="row">
	  ...
	  <div class="col-md-5">
		<div>
		  <h2><b>"Greetings from England,</b></h2>
		  <p>
			a land of timeless landmarks and modern innovation, nestled in northwestern Europe with lush countryside, bustling cities, world-class education, vibrant culture, and the British Pound (GBP) as its currency."
		  </p>
		</div>
	  </div>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
			<div class="carousel-item active" data-bs-interval="2000">
			  <img src="img/eng1.jpg" class="d-block w-100" alt="Banner 1">
			</div>
			<div class="carousel-item" data-bs-interval="2000">
			  <img src="img/eng2.jpg" class="d-block w-100" alt="Banner 2">
			</div>
			<div class="carousel-item" data-bs-interval="2000">
			  <img src="img/eng3.jpg" class="d-block w-100" alt="Banner 3">
			</div>
		  </div>
...
<button class="filter-option" onclick="location.href='program_eng.php'">Program Wise</button>
<button class="filter-option" onclick="location.href='tuitionfee_eng.php'">Tuition Fees Wise</button>
<button class="filter-option" onclick="location.href='rank_eng.php'">World Ranking Wise</button>
		</div>
	  </div>
	</div>
  <!-- </div> -->
...
<div id="banner">
  ...
  TuitionFee Type Based Universities
</h2>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-5">
                                    ...
                                    <?php
                                        ...
                                        if ($university_name == 'imperial college london') {
                                            $logo_path = 'universities/img/icllogo.jpeg';
                                        } elseif ($university_name == 'university of cambridge') {
                                            $logo_path = 'universities/img/uclogo.png';
                                        } elseif ($university_name == 'university college london') {
                                            $logo_path = 'universities/img/ucllogo.png';
                                        } elseif ($university_name == 'university of oxford') {
                                            $logo_path = 'universities/img/uologo.jpeg';
                                        }
...
if ($university_name == 'imperial college london') {
    ...
    echo '<a href="universities/IcL.html" class="university-link"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
} elseif ($university_name == 'university of cambridge') {
    echo '<h5 class="text-center uni-title">';
    echo '<a href="universities/uc.html" class="university-link"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
} elseif ($university_name == 'university college london') {
    echo '<h5 class="text-center uni-title">';
    echo '<a href="universities/ucl.html" class="university-link"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
} elseif ($university_name == 'university of oxford') {
    echo '<h5 class="text-center uni-title">';
    echo '<a href="universities/UO.html" class="university-link"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
} else {
...
<p><strong style="font-family: 'Open Sans', sans-serif; font-size: 17px">World Rank:</strong> <span style="font-family: 'Times New Roman', serif; font-size: 19px"><?php echo htmlspecialchars($row['World_Rank']); ?></span></p>     
                ...
                <?php else: ?>
                    <p class="text-center text-danger">No universities found for ENGLAND.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
