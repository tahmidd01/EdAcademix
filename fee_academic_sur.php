    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Tuition Fees at Sapienza University of Rome</b></h1><br><br>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Semester_Or_Trimester_Fees']); ?></td>
