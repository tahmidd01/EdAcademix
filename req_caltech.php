...
/* banner css part start */
 #banner {
  position: relative;
  height: 190vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_caltech.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_caltech.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_caltech.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_caltech.php">Requeirments</a>
        <a href="./universities/CIT_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at California Institute of Technology</u>
</h1>
...
.typing-text {
  ...
  animation: typing 12s steps(55, end) infinite, blink 0.7s step-end infinite;
  white-space: nowrap;
}
