...
$query = "SELECT 
    ...
    WHERE
        c.name = 'England'
        AND u.name = 'Imperial College London'
    ORDER BY 
        p.name, f.name";
...
/* banner css part start */
 #banner {
  position: relative;
  height: 310vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_icl.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_icl.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_icl.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_icl.php">Requeirments</a>
        <a href="./universities/icl_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Imperial College London</u>
</h1>
...
.typing-text {
  ...
  animation: typing 12s steps(50, end) infinite, blink 0.7s step-end infinite;
  white-space: nowrap;
}
