    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Undergraduate Programs at Harvard University</b></h1><br><br>
                ...
                <div class="table-responsive">
                    ...
                    <?php else: ?>
                        <h2 class="text-center" style="color: white;">No results found for Undergraduate Programs at Harvard University.</h2>
                    <?php endif; ?>
                </div>
            </div>
        </div>
