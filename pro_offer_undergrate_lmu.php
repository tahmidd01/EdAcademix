...
$query = "
    ...
    FROM 
        Program p
    INNER JOIN 
        UniversityProgramField upf ON p.program_id = upf.program_id
    INNER JOIN 
        university u ON upf.university_id = u.university_id
    INNER JOIN 
        countrylist c ON u.country_id = c.country_id
    INNER JOIN 
        Subject s ON upf.subject_id = s.subject_id
    WHERE 
        p.name = 'Undergraduate Programs'
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="universities/img/lmupro.jpeg">
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="desh3.html">Back to Country</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="pro_academic_lmu.php"><b>Programs</b></a></li>
                  <li><a class="dropdown-item" href="fee_academic_lmu.php"><b>Tution Fees</b></a></li>
                  <li><a class="dropdown-item" href="scholar_academic_lmu.php"><b>Scholarship</b></a></li>
                  <li><hr class="dropdown-divider"></li>
                 
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="req_lmu.php">Requirements</a>
              </li>
              <li class="nav-item">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="pro_offer_undergrate_lmu.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_graduate_lmu.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_phd_lmu.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="tuition_undergrate_lmu.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_graduate_lmu.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_phd_lmu.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2">
          <a class="nav-link2 active" aria-current="page" href="fields_lmu.php">Field Of Study</a>
        </li>
    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Undergraduate Programs at Ludwig Maximilian University of Munich</b></h1><br><br>
                        ...
                        <table class="table table-bordered" style="background-color: #0C2132; color: white; border: 5px solid black;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #0C2132; color: white; border: 5px solid black;">Subject Name</th>
                                    <th style="background-color: #0C2132; color: white; border: 5px solid black;">Description</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                                $currentProgram = null; // To track the current program name and avoid duplication
                                while ($row = $result->fetch_assoc()): 
                                ?>
                                    <tr>
                                        <?php if ($currentProgram != $row['Program_Name']): ?>
                                            <!-- Display Program Name only for the first subject in its group -->
                                            <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Program_Name']); ?></td>
                                            <?php $currentProgram = $row['Program_Name']; ?>
                                        <?php else: ?>
                                            <!-- Empty cell if it's not the first subject in the group -->
                                            <td style="color: white; background-color: #0C2132; border: 5px solid black;"></td>
                                        <?php endif; ?>
                                        <!-- Subject Name and Description -->
                                        <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Subject_Name']); ?></td>
                                        <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Subject_Description']); ?></td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
                        </table>
                    <?php else: ?>
                        <h2 class="text-center" style="color: white;">No results found for Undergraduate Programs at Australian National University.</h2>
                    <?php endif; ?>
                </div>
            </div>
        </div>
