...
.card:hover {
  ...
  box-shadow: 0 12px 30px rgba(21, 92, 96, 0.4);
  z-index: 2;
}

/* Slight float animation loop */
...
/* Apply float animation to cards continuously */
.card-body {
...
<div id="banner">
  ...
  <u class="typing-text">Scholarships at Massachusetts Institute of Technology</u>
</h1>
                <div class="row">
                    <?php 
                    while ($row = $result->fetch_assoc()): 
                    ?>
<div class="col-md-4 mb-4" data-aos="fade-up" data-aos-offset="100">
    <div class="card" style="background-color: white; border: 2px solid black; border-radius: 10px;">
        <div class="card-body" style="color: black;">
            <h5 class="card-title" style="font-weight: bold;">
                <?php echo htmlspecialchars($row['Program_Name']); ?> - <?php echo htmlspecialchars($row['Field_Of_Study']); ?>
            </h5>
            <p class="card-text" style="font-weight: normal;">
                <?php echo htmlspecialchars($row['Scholarship_Details']); ?>
            </p>
        </div>
    </div>
</div>
