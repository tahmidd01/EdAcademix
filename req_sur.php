...
$query = "SELECT 
    ...
    WHERE
        c.name = 'Italy'
        AND u.name = 'Sapienza University of Rome'
    ORDER BY 
        p.name, f.name;
";
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="universities/img/surlogo.jpeg">
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="desh4.html">Back to Country</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="pro_academic_sur.php"><b>Programs</b></a></li>
                  <li><a class="dropdown-item" href="fee_academic_sur.php"><b>Tution Fees</b></a></li>
                  <li><a class="dropdown-item" href="scholar_academic_sur.php"><b>Scholarship</b></a></li>
                  <li><hr class="dropdown-divider"></li>
                 
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="req_sur.php">Requirements</a>
              </li>
              <li class="nav-item">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="pro_offer_undergrate_sur.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_graduate_sur.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_phd_sur.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="tuition_undergrate_sur.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_graduate_sur.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_phd_sur.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2">
          <a class="nav-link2 active" aria-current="page" href="fields_sur.php">Field Of Study</a>
        </li>
    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Admission Requirements at Sapienza University of Rome</b></h1><br><br>
                    ...
                    <table class="table table-bordered" style="background-color: #0C2132; color: white; border: 5px solid black;">
                        <thead>
                            <tr>
                                ...
                                <th style="background-color: #0C2132; color: white; border: 5px solid black;">Academic Qualification</th>
                                <th style="background-color: #0C2132; color: white; border: 5px solid black;">Language Requirement</th>
                                <th style="background-color: #0C2132; color: white; border: 5px solid black;">Entrance Exam</th>
                                <th style="background-color: #0C2132; color: white; border: 5px solid black;">Other Requirements</th>
                                <th style="background-color: #0C2132; color: white; border: 5px solid black;">Application Deadline</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Academic_Qualification']); ?></td>
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Language_Requirement']); ?></td>
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Entrance_Exam']); ?></td>
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Other_Requirements']); ?></td>
                                    <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Application_Deadline']); ?></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
