...
$query = "
    ...
    WHERE 
        ...
        AND c.name = 'United States of America'
    ORDER BY 
        s.name
";
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="universities/img/caltechlogo.jpeg">
          </a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="pro_academic_caltech.php"><b>Programs</b></a></li>
                  <li><a class="dropdown-item" href="fee_academic_caltech.php"><b>Tution Fees</b></a></li>
                  <li><a class="dropdown-item" href="scholar_academic_caltech.php"><b>Scholarship</b></a></li>
                  <li><hr class="dropdown-divider"></li>
                 
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="req_caltech.php">Requirements</a>
              </li>
              <li class="nav-item">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="pro_offer_undergrate_caltech.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_graduate_caltech.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="pro_offer_phd_caltech.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2 dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="tuition_undergrate_caltech.php"><b>Undergraduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_graduate_caltech.php"><b>Graduate</b></a></li>
            <li><a class="dropdown-item" href="tuition_phd_caltech.php"><b>PhD</b></a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
        <li class="nav-item2">
          <a class="nav-link2 active" aria-current="page" href="fields_caltech.php">Field Of Study</a>
        </li>
    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Undergraduate Programs at California Institute of Technology</b></h1><br><br>
