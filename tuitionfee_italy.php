...
// Define the query to fetch university details based on tuition fee categories for Australian universities
$query = "SELECT 
        u.name AS University_Name,
        u.global_rank AS World_Rank,
        GROUP_CONCAT(DISTINCT REPLACE(p.name, ' Programs', '') SEPARATOR ', ') AS Program_Type,
        GROUP_CONCAT(DISTINCT tf.fee_category ORDER BY FIELD(tf.fee_category, 'Free', 'Medium', 'High') SEPARATOR ', ') AS Tuition_Fee_Type,
    ...
    GROUP BY 
        u.university_id
    ORDER BY 
        FIELD(SUBSTRING_INDEX(GROUP_CONCAT(DISTINCT tf.fee_category ORDER BY FIELD(tf.fee_category, 'Free', 'Medium', 'High') SEPARATOR ','), ',', 1), 'Free', 'Medium', 'High')
";
...
<head>
	...
	<!-- <link rel="stylesheet"  href="css/tagcon.css"> -->
...
<form class="d-flex" role="search" method="get" action="search_italy.php" onsubmit="return validateSearch()">
...
<nav class="second-navbar">
	<div class="container">
	  <ul class="nav-list">
		...
		<li class="left-group">
		  ...
		  <a href="about_italy.php">About</a>
		  <a href="uni_italy.php">Universities</a>
		</li>
 ...
 <div class="container-fluid mt-0">
	<div class="row">
	  ...
	  <div class="col-md-5">
		<div>
		  <h2><b>"Ciao and welcome to Italy,</b></h2>
		  <p>
			the Southern European gem where stunning coastlines meet historic cities, offering vibrant lifestyles, creative education, the Euro (EUR), and a dazzling culture of fashion, cuisine, and timeless art."
		  </p>
		</div>
	  </div>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
			<div class="carousel-item active" data-bs-interval="2000">
			  <img src="img/it1.jpg" class="d-block w-100" alt="Banner 1">
			</div>
			<div class="carousel-item" data-bs-interval="2000">
			  <img src="img/it2.jpg" class="d-block w-100" alt="Banner 2">
			</div>
			<div class="carousel-item" data-bs-interval="2000">
			  <img src="img/it3.png" class="d-block w-100" alt="Banner 3">
			</div>
		  </div>
...
<button class="filter-option" onclick="location.href='program_italy.php'">Program Wise</button>
<button class="filter-option" onclick="location.href='tuitionfee_italy.php'">Tuition Fees Wise</button>
<button class="filter-option" onclick="location.href='rank_italy.php'">World Ranking Wise</button>
		</div>
	  </div>
	</div>
  <!-- </div> -->
...
<h2 class="text-center" style="font-family: Times New Roman, Times, serif; font-size: 30px; font-weight: bold; text-decoration: underline;">TuitionFee Type Based Universities</h2>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-5">
                                    ...
                                    <?php
                                        ...
                                        if ($university_name == 'politecnico di milano') {
                                            $logo_path = 'universities/img/polimilogo.jpeg';
                                        } elseif ($university_name == 'sapienza university of rome') {
                                            $logo_path = 'universities/img/surlogo.jpeg';
                                        } elseif ($university_name == 'university of bologna') {
                                            $logo_path = 'universities/img/blognalogo.jpeg';
                                        } elseif ($university_name == 'university of padua') {
                                            $logo_path = 'universities/img/padualogo.jpeg';
                                        }
                                    ...
                                    <div class="card-body" style="background-color: #95CCCF; color: black;">
                                        <h5 class="card-title">
                                        <?php
                                            // Check university name and link accordingly
                                            if ($university_name == 'politecnico di milano') {
    echo '<h5 style="text-align: center; font-family: Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif; font-weight: bolder; font-size: 25px">';
    echo '<a href="universities/Milano.html" class="text-black" style="text-decoration: none;"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
                                            } elseif ($university_name == 'sapienza university of rome') {
    echo '<h5 style="text-align: center; font-family: Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif; font-weight: bolder; font-size: 25px">';
    echo '<a href="universities/SUR.html" class="text-black" style="text-decoration: none;"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
                                            } elseif ($university_name == 'university of bologna') {
    echo '<h5 style="text-align: center; font-family: Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif; font-weight: bolder; font-size: 25px">';
    echo '<a href="universities/bologna.html" class="text-black" style="text-decoration: none;"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
                                            } elseif ($university_name == 'university of padua') {
    echo '<h5 style="text-align: center; font-family: Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif; font-weight: bolder; font-size: 25px">';
    echo '<a href="universities/padua.html" class="text-black" style="text-decoration: none;"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
                                            } else {
    echo '<h5 style="text-align: center; font-family: Lucida Sans, Lucida Sans Regular, Lucida Grande, Lucida Sans Unicode, Geneva, Verdana, sans-serif; font-weight: bolder; font-size: 25px">'; htmlspecialchars($row['University_Name']) . '</h5>';
                                            }
                                        ?>
                                         </h5>
...
<p><strong style="font-family: 'Open Sans', sans-serif; font-size: 17px">World Rank:</strong> <span style="font-family: 'Times New Roman', serif; font-size: 19px"><?php echo htmlspecialchars($row['World_Rank']); ?></span></p>  
                ...
                <?php else: ?>
                    <p class="text-center text-danger">No universities found for ITALY.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
