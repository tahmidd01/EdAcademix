                                ...
                                <div class="card mb-5">
                                    ...
                                    <?php
                                        ...
                                        if ($university_name == 'australian national university') {
                                            $logo_path = 'universities/img/anulogo.jpeg';
                                        } elseif ($university_name == 'university of melbourne') {
                                            $logo_path = 'universities/img/umlogo.jpeg';
                                        } elseif ($university_name == 'university of sydney') {
                                            $logo_path = 'universities/img/uslogo.jpeg';
                                        } elseif ($university_name == 'university of queensland') {
                                            $logo_path = 'universities/img/uqlogo.jpeg';
                                        }
...
if ($university_name == 'australian national university') {
    ...
    echo '<h5 class="text-center uni-title">';
    echo '<a href="universities/qu.html" class="university-link"><strong>' . htmlspecialchars($row['University_Name']) . '</strong></a>';
} else {
