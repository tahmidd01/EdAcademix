...
// Define the SQL query for scholarship data
$query = "SELECT DISTINCT
    p.name AS Program_Name,
    f.name AS Field_Of_Study,
    tf.scholarship_details AS Scholarship_Details
FROM 
    Program p
INNER JOIN 
...
INNER JOIN 
    tuitionfee tf ON upf.program_id = tf.program_id AND upf.field_id = tf.field_id
INNER JOIN 
    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Scholarships at Sapienza University of Rome</b></h1><br><br>
                <div class="row">
                    <?php 
                    while ($row = $result->fetch_assoc()): 
                    ?>
                        <div class="col-md-4 mb-4">
                            <div class="card" style="background-color: #0C2132; border: 2px solid #ffffff;">
                                <div class="card-body" style="color: white;">
                                    <h5 class="card-title"><?php echo htmlspecialchars($row['Program_Name']); ?> - <?php echo htmlspecialchars($row['Field_Of_Study']); ?></h5>
                                    <p class="card-text"><?php echo htmlspecialchars($row['Scholarship_Details']); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
