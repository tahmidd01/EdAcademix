...
$query = "SELECT 
    ...
    WHERE
        c.name = 'Germany'
        AND u.name = 'Ludwig Maximilian University of Munich'
    ORDER BY 
        p.name, f.name";
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_lmu.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_lmu.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_lmu.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_lmu.php">Requeirments</a>
        <a href="./universities/lmu_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Ludwig Maximilian University</u>
</h1>
