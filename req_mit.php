...
/* banner css part start */
 #banner {
  position: relative;
  height: 165vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_mit.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_mit.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_mit.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_mit.php">Requeirments</a>
        <a href="./universities/mit_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Massachusetts Institute of Technology</u>
</h1>
...
@keyframes typing {
  ...
  50% {
    width: 58ch; /* Adjust based on your text length */
  }
  100% {
    width: 0ch;
  }
...
.typing-text {
  ...
  animation: typing 12s steps(58, end) infinite, blink 0.7s step-end infinite;
  white-space: nowrap;
}
