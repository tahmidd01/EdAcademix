...
$query = "SELECT 
    ...
    WHERE
        c.name = 'Australia'
        AND u.name = 'Australian National University'
    ORDER BY 
        p.name, f.name";
...
/* banner css part start */
 #banner {
  position: relative;
  height: 260vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_anu.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_anu.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_anu.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_anu.php">Requeirments</a>
        <a href="./universities/anucontact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Australian National University</u>
</h1>
...
@keyframes typing {
  ...
  50% {
    width: 53ch; /* Adjust based on your text length */
  }
  100% {
    width: 0ch;
  }
