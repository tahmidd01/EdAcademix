...
$query = "SELECT 
    ...
    FROM 
        universityprogramfield upf
    INNER JOIN 
        program p ON upf.program_id = p.program_id
    INNER JOIN
        fieldofstudy f ON upf.field_id = f.field_id
    INNER JOIN 
    ...
    WHERE               
        u.name = 'California Institute of Technology' 
    ...
    <div class="banner_overlay">
        <div class="container mt-5">
            <div class="banner_content">
                <h1 class="text-center" style="color: white;"><b>Fields Wise Subjects</b></h1><br><br>
                ...
                <div class="table-responsive">
                    <?php if ($result && $result->num_rows > 0): ?>
                        <table class="table table-bordered" style="background-color: #0C2132; color: white; border: 5px solid black;">
                            <thead>
                                <tr>
                                    <th style="background-color: #0C2132; color: white; border: 5px solid black;">Field Name</th>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        <td style="color: white; background-color: #0C2132; border: 5px solid black;"><?php echo htmlspecialchars($row['Field_Name']); ?></td>
                    ...
                    <?php else: ?>
                        <h2 class="text-center" style="color: white;">No results found.</h2>
                    <?php endif; ?>
                </div>
            </div>
        </div>
