...
$query = "SELECT 
    ...
    WHERE
        c.name = 'England'
        AND u.name = 'University of Cambridge'
    ORDER BY 
        p.name, f.name";
...
/* banner css part start */
 #banner {
  position: relative;
  height: 240vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_uc.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_uc.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_uc.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_uc.php">Requeirments</a>
        <a href="./universities/uc_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at University of Cambridge</u>
</h1>
