...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_cub.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_cub.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_cub.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_cub.php">Requeirments</a>
        <a href="./universities/CUB_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Charité Universitätsmedizin Berlin</u>
</h1>
