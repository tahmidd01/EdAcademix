...
$query = "SELECT 
    ...
    WHERE
        c.name = 'England'
        AND u.name = 'University College London'
    ORDER BY 
        p.name, f.name";
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_ucl.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_ucl.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_ucl.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_ucl.php">Requeirments</a>
        <a href="./universities/ucl_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at University College London</u>
</h1>
