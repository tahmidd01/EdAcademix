...
<h1>✍️ Writing Course Playlist</h1>
...
<div class='video-card'>
    ...
    <div class='label'>Writing Video $num</div>
</div>";
    }
} else {
    echo "<p style='color: red;'>No videos found for Writing section.</p>";
}
$conn->close();
?>
</div>
