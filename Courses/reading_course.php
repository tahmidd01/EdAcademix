...
<div class='video-card'>
    ...
    <div class='label'>Reading Video $num</div>
</div>";
    }
} else {
    echo "<p style='color: red;'>No videos found for Reading section.</p>";
}
$conn->close();
?>
</div>
