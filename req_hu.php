...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				<li><a class="academics-options" href="pro_academic_hu.php">Programs</a></li>
				<li><a class="academics-options" href="scholar_academic_hu.php">Scholarships</a></li>
				<li><a class="academics-options" href="fee_academic_hu.php">Tution Fees</a></li>

				<li><hr class="dropdown-divider"></li>
			</ul>
			</li>

        <a href="req_hu.php">Requeirments</a>
        <a href="./universities/harvard_contact.html">Help-Line</a>
      </li>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Harvard University</u>
</h1>
