...
/* banner css part start */
 #banner {
  position: relative;
  height: 185vh; /* Full viewport height */
  display: flex;
  align-items: center;
...
<li class="nav-item dropdown-ac" id="academicsDropdown">
			...
			<ul class="dropdown-menu" id="dropdownMenu">
				...
				<li><a class="academics-options" href="scholar_academic_heib.php">Scholarships</a></li>
        ...
        <a href="req_heib.php">Requeirments</a>
...
<div id="banner">
  ...
  <u class="typing-text">Admission Requirements at Heidelberg University</u>
</h1>
