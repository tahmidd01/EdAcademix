...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['start_test'])) {
        if ($_POST['start_test'] === 'yes') {
            header("Location: reading_test.php");
            exit();
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Reading Test Confirmation</title>
    <style>
        * {
...
<body>
    <div class="card">
        <h2>You're about to begin the<br><strong>Reading Test</strong>.<br>Do you want to proceed?</h2>
