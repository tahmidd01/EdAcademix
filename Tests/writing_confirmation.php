...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['start_test'])) {
        if ($_POST['start_test'] === 'yes') {
            header("Location: writing_test.php");
            exit();
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Writing Test Confirmation</title>
    <style>
        * {
...
<body>
    <div class="card">
        <h2>You're about to begin the<br><strong>Writing Test</strong>.<br>Do you want to proceed?</h2>
