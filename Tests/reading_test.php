...
if ($current_set === null) {
    ...
    ">
        ...
        <p style="font-size: 1.1em; color: #333;">
            You have already completed all available <strong>Reading Test Sets</strong>.
        </p>
        <p style="color: #555;">
...
.dark-mode .passage h2 {
    color: #ffffff; /* White text for dark mode */
    border-bottom: 2px solid #555; /* Softer contrast border */
}
.dark-mode .passage p {
    font-size: 17px;
    line-height: 1.8;
...
if (isset($section_to_passage[$section_number]) && isset($passages[$section_to_passage[$section_number]])) {
    ...
    echo "<h2>Section $section_number - $passage_title</h2>";
    echo "<p>" . nl2br(htmlspecialchars($passage['PassageContent'])) . "</p>";
} else {
    echo "<h2>Section $section_number - Passage not found.</h2>";
}
echo "</div>";


        echo "<div class='question-block'>";
        echo "<h3>Section $section_number - Questions</h3>";
        ...
        foreach ($questions as $q) {
            ...
            echo "<div>";
            echo "<p><strong>Q{$display_number}:</strong> $question_text</p>";
