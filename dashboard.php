...
.sidebar-toggle-btn:hover {
    ...
    box-shadow: 0 6px 12px rgba(19, 1, 1, 0.15);
...
.overall-score {
  background: linear-gradient(135deg, #f8faff, #eaf3ff);
  padding: 40px 60px;
    border-radius: 20px;
  margin: 40px auto;
  box-shadow:
    0 15px 30px rgba(0, 123, 255, 0.2),
...
.overall-score:hover {
  ...
  box-shadow:
    0 25px 60px rgba(0, 123, 255, 0.25),
...
.dark-mode .overall-score {
  ...
  box-shadow:
    0 15px 30px rgba(0, 123, 255, 0.15),
    inset 0 2px 4px rgba(255, 255, 255, 0.04);
  color: #ddd;
}

.dark-mode .overall-score:hover {
  transform: perspective(1000px) translateZ(20px);
  box-shadow:
    0 25px 60px rgba(0, 123, 255, 0.3),
    inset 0 3px 6px rgba(255, 255, 255, 0.06);
}

.dark-mode .overall-score h3 {
  color: #1a9fff;
  text-shadow: 0 1px 2px rgba(0, 0, 0, 0.5);
}

.dark-mode .overall-score p {
  color: #ccc;
}

.dark-mode .overall-score strong {
  color: #fff;
}
.performance-trends {
  background: linear-gradient(135deg, #f9fcff, #e0ecff);
  border-radius: 20px;
  padding: 36px 100px;
  margin: 40px auto;
  box-shadow: 0 15px 35px rgba(0, 123, 255, 0.25), inset 0 2px 4px rgba(255, 255, 255, 0.9);
  max-width: 720px;
  transition: all 0.4s ease;
  transform: perspective(1000px) translateZ(0);
}

.performance-trends:hover {
  transform: perspective(1000px) translateZ(15px);
  box-shadow: 0 25px 60px rgba(0, 123, 255, 0.35), inset 0 4px 8px rgba(255, 255, 255, 0.6);
}
...
.dark-mode .performance-trends {
  background: linear-gradient(135deg, #202328, #2c3036);
  box-shadow: 0 15px 35px rgba(26, 115, 232, 0.15), inset 0 2px 4px rgba(255, 255, 255, 0.03);
}

.dark-mode .performance-trends:hover {
  transform: perspective(1000px) translateZ(15px);
  box-shadow: 0 25px 60px rgba(26, 115, 232, 0.25), inset 0 3px 6px rgba(255, 255, 255, 0.04);
}

.dark-mode .performance-trends h3 {
  color: #1a9fff;
}

.dark-mode canvas#performanceChart {
...
.section-performance {
  background: linear-gradient(135deg, #f9fafe, #e9f1ff);
  padding: 40px 60px;
  border-radius: 20px;
  margin: 40px auto;
...
.dark-mode .section-performance:hover {
  box-shadow: 
    0 25px 60px rgba(0, 123, 255, 0.35),
    inset 0 3px 6px rgba(255, 255, 255, 0.08);
}

.dark-mode .section-performance h3 {
  color: #9ecbff;
...
.dark-mode .performance-item strong {
  color: #66b2ff;
}
